...
const SERIES_DATA = [
  ...
  { day: "TUE", name: "Art + Finance",
    ...
    read: "The structural read at accessible depth. Where ArtTactic prices out, we land.",
  ...
  { day: "WED·alt", name: "The World Through Art",
    ...
    read: "What artists registered before the headlines moved. The widest top-of-funnel in the system.",
    accent: "var(--ai-teal)" },
  { day: "THU", name: "Artist Spotlight",
    headline: "Structural profiles of working artists, with direct contact named.",
