...
const SERIES_DATA = [
  ...
  { day: "WED·alt", name: "The World Through Art",
    headline: "World news read through the work artists were already making.",
    kicker: "Runs when the news has an art angle worth reading",
    read: "Not art-world news. The other direction — what artists in the country saw coming first.",
    accent: "var(--ai-teal)" },
